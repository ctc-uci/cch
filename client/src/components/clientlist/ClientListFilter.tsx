...
export const ClientListFilter = ({ setFilterQuery }: ClientListFilterProps) => {
  ...
  const columns = [
    ...
    { name: "Date of Birth", value: "clients.date_of_birth", type: "date" },
    {
      ...
      value: "case_managers.first_name",
      type: "string",
    },
    {
      name: "Case Manager Last Name",
      value: "case_managers.last_name",
      type: "string",
    },
    ...
    { name: "Email", value: "clients.email", type: "string" },
    {
      ...
      value: "clients.emergency_contact_name",
      type: "string",
    },
    {
      name: "Emergency Contact Phone",
      value: "clients.emergency_contact_phone_number",
      type: "string",
    },
    ...
    { name: "Entrance Date", value: "clients.entrance_date", type: "date" },
    {
      ...
      value: "clients.estimated_exit_date",
      type: "date",
    },
    { name: "Exit Date", value: "clients.exit_date", type: "date" },
    { name: "Bed Nights", value: "clients.bed_nights", type: "number" },
    {
      name: "Bed Nights for Children",
      value: "clients.bed_nights_children",
      type: "number",
    },
    {
      name: "Pregnant Upon Entry",
      value: "clients.pregnant_upon_entry",
      type: "boolean",
    },
    {
      name: "Disabled Children",
      value: "clients.disabled_children",
      type: "boolean",
    },
    { name: "Ethnicity", value: "clients.ethnicity", type: "string" },
    { name: "Race", value: "clients.race", type: "string" },
    {
      name: "City of Last Permanent Residence",
      value: "clients.city_of_last_permanent_residence",
      type: "string",
    },
    { name: "Prior Living", value: "clients.prior_living", type: "string" },
    {
      name: "Prior Living City",
      value: "clients.prior_living_city",
      type: "string",
    },
    {
      name: "Shelter in Last 5 Years",
      value: "clients.shelter_in_last_five_years",
      type: "boolean",
    },
    {
      name: "Homelessness Length",
      value: "clients.homelessness_length",
      type: "number",
    },
    {
      name: "Chronically Homeless",
      value: "clients.chronically_homeless",
      type: "boolean",
    },
    {
      name: "Attending School Upon Entry",
      value: "clients.attending_school_upon_entry",
      type: "boolean",
    },
    {
      name: "Employment Gained",
      value: "clients.employement_gained",
      type: "boolean",
    },
    {
      name: "Reason for Leaving",
      value: "clients.reason_for_leaving",
      type: "string",
    },
    {
      name: "Specific Reason for Leaving",
      value: "clients.specific_reason_for_leaving",
      type: "string",
    },
    {
      name: "Specific Destination",
      value: "clients.specific_destination",
      type: "string",
    },
    { name: "Savings Amount", value: "clients.savings_amount", type: "number" },
    {
      name: "Attending School Upon Exit",
      value: "clients.attending_school_upon_exit",
      type: "boolean",
    },
    { name: "Reunified", value: "clients.reunified", type: "boolean" },
    {
      name: "Successful Completion",
      value: "clients.successful_completion",
      type: "boolean",
    },
    {
      name: "Destination City",
      value: "clients.destination_city",
      type: "string",
    },
  ];
