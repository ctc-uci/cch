...
export const SuccessStoryForm = ({
  ...
  return (
    ...
    //     <Text variant={"body"}>
    //       We are committed to providing you the best help possible, so we
    //       welcome your comments. <br></br>
    //       Please fill out the questionnaire below and we will get back to you as
    //       soon as possible.
    //     </Text>
    //   </VStack>
    ...
    //             variant={"body"}
    //           >
    //             <span style={{ fontWeight: "bold" }}>1.</span> What is your
    //             first name?
    //           </FormLabel>
    //           <Input
    //             name="name"
    ...
    //             variant={"body"}
    //           >
    //             <span style={{ fontWeight: "bold" }}>2.</span> Where is your
    //             site?
    //           </FormLabel>
    //           <Select
    //             name="site"
    ...
    //           variant={"body"}
    //         >
    //           <span style={{ fontWeight: "bold" }}>3.</span> Who is your
    //           manager?
    //         </FormLabel>
    //         <Select
    //           name="cm_id"
    ...
    //           variant={"body"}
    //         >
    //           <span style={{ fontWeight: "bold" }}>5.</span> Entrance Date to
    //           CCH
    //         </FormLabel>
    //         <Input
    //           name="entrance_date"
    ...
    //           variant={"body"}
    //         >
    //           <span style={{ fontWeight: "bold" }}>6.</span> Exit Date to CCH
    //         </FormLabel>
    //         <Input
    //           name="exit_date"
    //           type="date"
    ...
    //           variant={"body"}
    //         >
    //           <span style={{ fontWeight: "bold" }}>7.</span> Please tell us your
    //           situation before entering Colette's Children's Home. Please give
    //           as many details as you are comfortable with about your story, how
    //           long you were homeless, what led to homelessness, etc. We want to
    //           help people understand what being homeless is like.
    //         </FormLabel>
    ...
    //           variant={"body"}
    //         >
    //           <span style={{ fontWeight: "bold" }}>8.</span> Tell us about your
    //           time in CCH and how CCH was part of the solution to your situation
    //           and the impact it had on you and and/or your children. What was
    //           most helpful, what you learned, etc.{" "}
    //         </FormLabel>
    ...
    //           variant={"body"}
    //         >
    //           <span style={{ fontWeight: "bold" }}>9.</span> Tell us where you
    //           are now. If you are graduating where are you moving, working, how
    //           are your children doing, etc. Tell us a finish to your story.{" "}
    //         </FormLabel>
    ...
    //           variant={"body"}
    //         >
    //           <span style={{ fontWeight: "bold" }}>10.</span> If you had the
    //           opportunity to tell one of our donors what it meant to you to be
    //           at CCH or how important it is to provide our services to other
    ...
    //           variant={"body"}
    //         >
    //           <span style={{ fontWeight: "bold" }}>11.</span> Please give a 1 to
    //           2 sentence quote of what the CCH experience meant to you?{" "}
    //         </FormLabel>
    //         <Textarea name="quote" />
    //       </FormControl>
    ...
    //           variant={"body"}
    //         >
    //           <span style={{ fontWeight: "bold" }}>12.</span> Consent
    //         </FormLabel>
    //         <Radio
    //           type="radio"
    //           name="consent"
    ...
    //           variant={"body"}
    //         >
    //           <span style={{ fontWeight: "bold" }}>13.</span> Client Signature:
    //         </FormLabel>
    //         <Input />
    //       </FormControl>
    //       <FormControl isRequired>
    ...
    //           variant={"body"}
    //         >
    //           <span style={{ fontWeight: "bold" }}>13.</span> Date:
    //         </FormLabel>
    //         <Input
    //           name="date"
    //           type="date"
