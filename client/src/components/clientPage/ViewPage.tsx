          ...
          <Box mt={4}>
            ...
            <Stack spacing={3}>
              ...
              <Input
                ...
                onChange={(e) =>
                  setClient({ ...client, grant: e.target.value })
                }
              />
              <Input
                placeholder="Status"
              ...
              <Input
                ...
                onChange={(e) =>
                  setClient({ ...client, emergencyContactName: e.target.value })
                }
              />
              <Input
              ...
              <Input
                ...
                onChange={(e) =>
                  setClient({
                    ...client,
                    homelessnessLength: parseInt(e.target.value),
                  })
                }
              />
              <Input
                ...
                onChange={(e) =>
                  setClient({
                    ...
                    successfulCompletion:
                      e.target.value.toLowerCase() === "yes", // Convert to boolean
                  })
                }
              />
              <Input
              ...
              <Input
                ...
                onChange={(e) =>
                  setClient({ ...client, savingsAmount: e.target.value })
                }
              />
              <Input
                ...
                onChange={(e) =>
                  setClient({ ...client, specificDestination: e.target.value })
                }
              />
              <Input
                ...
                onChange={(e) =>
                  setClient({ ...client, estimatedExitdate: e.target.value })
                }
              />
              <Input
                ...
                onChange={(e) =>
                  setClient({ ...client, exitDate: e.target.value })
                }
              />
              <Input
                placeholder="Unit ID"
                ...
                onChange={(e) =>
                  setClient({ ...client, unitId: parseInt(e.target.value) })
                }
              />
              <Input
                ...
                onChange={(e) =>
                  setClient({ ...client, priorLiving: e.target.value })
                }
              />
              <Input
                ...
                onChange={(e) =>
                  setClient({ ...client, priorLivingCity: e.target.value })
                }
              />
              <Input
              ...
              <Input
                ...
                onChange={(e) =>
                  setClient({
                    ...client,
                    specificReasonForLeaving: e.target.value,
                  })
                }
              />
              <Input
                ...
                onChange={(e) =>
                  setClient({ ...client, reasonForLeaving: e.target.value })
                }
              />
